...
#define X_M1_PORT           GPIO_PORTH_BASE
#define X_M1_PIN            GPIO_PIN_2      // output

#define X_M0_PORT           GPIO_PORTH_BASE
#define X_M0_PIN            GPIO_PIN_3      // output

#define X_DIR_PORT          GPIO_PORTH_BASE
#define X_DIR_PIN           GPIO_PIN_4      // output

#define X_ENABLE_PORT       GPIO_PORTH_BASE
#define X_ENABLE_PIN        GPIO_PIN_5      // output

#define X_NSLEEP_PORT       GPIO_PORTH_BASE
#define X_NSLEEP_PIN        GPIO_PIN_6      // output

#define X_NFAULT_PORT       GPIO_PORTH_BASE
#define X_NFAULT_PIN        GPIO_PIN_7      // input
...
#define X_MOTOR_PWM_OUT     GPIO_PH0_M0PWM0
...
#define Y_M0_PIN            GPIO_PIN_1      // output

#define Y_DIR_PORT          GPIO_PORTB_BASE
#define Y_DIR_PIN           GPIO_PIN_2      // output

#define Y_ENABLE_PORT       GPIO_PORTB_BASE
#define Y_ENABLE_PIN        GPIO_PIN_3      // output

#define Y_NSLEEP_PORT       GPIO_PORTF_BASE
#define Y_NSLEEP_PIN        GPIO_PIN_6      // output

#define Y_NFAULT_PORT       GPIO_PORTF_BASE
...
#define Z_PWM_OUT           PWM_OUT_4

#define Z_M1_PORT           GPIO_PORTE_BASE
#define Z_M1_PIN            GPIO_PIN_0      // output

#define Z_M0_PORT           GPIO_PORTE_BASE
#define Z_M0_PIN            GPIO_PIN_1      // output

#define Z_DIR_PORT          GPIO_PORTE_BASE
#define Z_DIR_PIN           GPIO_PIN_2      // output

#define Z_ENABLE_PORT       GPIO_PORTE_BASE
#define Z_ENABLE_PIN        GPIO_PIN_3      // output

#define Z_NSLEEP_PORT       GPIO_PORTE_BASE
#define Z_NSLEEP_PIN        GPIO_PIN_5      // output

#define Z_NFAULT_PORT       GPIO_PORTE_BASE
#define Z_NFAULT_PIN        GPIO_PIN_6      // input

#define Z_STEP_PORT         GPIO_PORTE_BASE
#define Z_STEP_PIN          GPIO_PIN_4      // output

#define Z_MOTOR_PWM_BASE    PWM0_BASE       //  M0PWM6
#define Z_MOTOR_PWM_CHANNEL 4

#define Z_MOTOR_STEP        GPIO_PE4_M0PWM4
...
#define EX_M1_PORT           GPIO_PORTG_BASE
#define EX_M1_PIN            GPIO_PIN_0      // output

#define EX_M0_PORT           GPIO_PORTG_BASE
#define EX_M0_PIN            GPIO_PIN_1      // output

#define EX_DIR_PORT          GPIO_PORTG_BASE
#define EX_DIR_PIN           GPIO_PIN_2      // output

#define EX_ENABLE_PORT       GPIO_PORTG_BASE
#define EX_ENABLE_PIN        GPIO_PIN_3      // output

#define EX_NSLEEP_PORT       GPIO_PORTG_BASE
#define EX_NSLEEP_PIN        GPIO_PIN_4      // output

#define EX_NFAULT_PORT       GPIO_PORTG_BASE
#define EX_NFAULT_PIN        GPIO_PIN_5      // input

#define EX_STEP_PORT         GPIO_PORTG_BASE
#define EX_STEP_PIN          GPIO_PIN_6      // output

#define EX_MOTOR_PWM_BASE    PWM0_BASE       //  M0PWM5
#define EX_MOTOR_PWM_CHANNEL 6

#define EX_MOTOR_STEP        GPIO_PG6_M0PWM6

/*  EXTRUDER HEATER */
#define EX_HEATER_PWM_BLOCK     PWM_GEN_2
#define EX_HEATER_PWM_OUT       PWM_OUT_5

#define EX_HEATER_PWM_PORT      GPIO_PORTF_BASE
#define EX_HEATER_PWM_PIN       GPIO_PIN_1

#define EX_HEATER_PWM_BASE      PWM1_BASE
#define EX_HEATER_PWM_CHANNEL   5

#define EX_HEATER_PWM_PIN_MAP   GPIO_PF1_M1PWM5
...
/*  BED HEATER   */
#define BED_HEATER_PWM_PIN_MAP   GPIO_PF2_M1PWM6

#define BED_HEATER_PWM_BLOCK     PWM_GEN_3
#define BED_HEATER_PWM_OUT       PWM_OUT_6

#define BED_HEATER_PWM_PORT      GPIO_PORTF_BASE
#define BED_HEATER_PWM_PIN       GPIO_PIN_2

#define BED_HEATER_PWM_BASE      PWM1_BASE
#define BED_HEATER_PWM_CHANNEL   6
